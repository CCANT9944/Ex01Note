...
fun NoteEditScreen(
    ...
    Scaffold(
        topBar = {
            // Use the standard Material3 TopAppBar here (SmallTopAppBar may not be available
            // in the project's Material3 version) — TopAppBar provides the same title
            // + navigationIcon approach and avoids unresolved-reference errors.
            TopAppBar(
                title = {
                    Text(
                ...
                navigationIcon = {
                    // Pass the function reference directly for clarity
